...
public class SnakeHeadController : MonoBehaviour {
    ...
    void Update()
    {
        ...
        */
        ...
        movement = new Vector3(Cardboard.SDK.HeadPose.Orientation.x, 0 , Cardboard.SDK.HeadPose.Orientation.y);
        transform.Translate(  movement * speed);
        loseText.text = "X = " + Cardboard.SDK.HeadPose.Orientation.x + "\n Y = " + Cardboard.SDK.HeadPose.Orientation.y + "\n Z = " + Cardboard.SDK.HeadPose.Orientation.z;
